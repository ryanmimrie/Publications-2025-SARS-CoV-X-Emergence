# ==============================================================================
# ===== SARS-CoV-X Emergence: ABC Delta ========================================
# ==============================================================================
...
posterior <- read_csv(here("models", "ABC", "posterior_Alpha.csv")
...
print(mean(scotland$contact_matrices))
  ...
  outfile <- here("models", "ABC", "ABC_samples_Delta", sprintf("/%s_%s.csv", file_prefix, s))
